...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CirclePercentView_circleBgColor, getResources().getColor(R.color.white));
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.SM_6277FF));
        ...
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, getResources().getColor(R.color.SM_697BFE));
        endColor = typedArray.getColor(R.styleable.CirclePercentView_circleEndColor, getResources().getColor(R.color.SM_697BFE));
        typedArray.recycle();
        init();
    }
