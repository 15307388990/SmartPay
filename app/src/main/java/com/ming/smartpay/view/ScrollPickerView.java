...
import com.ming.smartpay.view.modelview.IPickerViewOperation;
...
public class ScrollPickerView extends RecyclerView {
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            ...
            int startX = screenX / 2 - mItemWidth / 2 - Tools.dpToPx(5);
            int stopX = mItemWidth + startX + Tools.dpToPx(5);
    ...
    private void initPaint() {
        if (mBgPaint == null) {
            ...
            mBgPaint.setStrokeWidth(Tools.dpToPx(1f));
        }
    }
