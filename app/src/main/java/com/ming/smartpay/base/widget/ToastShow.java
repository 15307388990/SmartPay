package com.ming.smartpay.base.widget;
...
public class ToastShow {
    ...
    public static void ds( CharSequence message) {
        if (null == toast) {
            toast = Toast.makeText(SmartpayApplication.getInstance(), message, Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER, 0, 0);

        } else {
            toast.setText(message);
        }
        if (SmartpayApplication.DEBUG) {
            toast.show();
        }
    }
    /**
	...
	public static void s( CharSequence message) {
		if (null == toast) {
			toast = Toast.makeText(SmartpayApplication.getInstance(), message, Toast.LENGTH_SHORT);
//			toast.setGravity(Gravity.CENTER, 0, 0);
		} else {
			toast.setText(message);
		}
	...
	public static void s(int resMsg) {
		if (null == toast) {
			toast = Toast.makeText(SmartpayApplication.getInstance(), resMsg, Toast.LENGTH_SHORT);
//			toast.setGravity(Gravity.CENTER, 0, 0);
		} else {
	...
	public static void show(CharSequence message, int duration) {
		if (null == toast) {
			toast = Toast.makeText(SmartpayApplication.getInstance(), message, duration);
			// toast.setGravity(Gravity.CENTER, 0, 0);
		} else {
			toast.setText(message);
		}
    ...
    public static void s(String msg){
		if (null == toast) {
			toast = Toast.makeText(SmartpayApplication.getInstance(), msg, Toast.LENGTH_SHORT);
//			toast.setGravity(Gravity.CENTER, 0, 0);
		} else {
			toast.setText(msg);
		}
